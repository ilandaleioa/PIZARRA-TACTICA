...
const FORMATIONS = {
  ...
  // Margen con el token: FWD=26%, DEF=74% (el círculo queda completamente fuera)
  '1-4-4-2': {
    my: [
      [50,  90],  // 1 GK
      [82,  74],  // 2 Lat Der
      ...
      [35,  74],  // 4 Central Izq
      [60,  74],  // 5 Central Der
      [34,  50],  // 6 Medio centro
      [82,  50],  // 7 Extremo Der
      [58,  50],  // 8 Medio centro
      [37,  26],  // 9 Delantero Izq
      [58,  26],  // 10 Delantero Der
    ...
    rival: [
      ...
      [82,  50],  // 7 Extremo Der
      [58,  50],  // 8 Medio centro
      [37,  74],  // 9 Delantero Izq
      [58,  74],  // 10 Delantero Der
      [10,  50],  // 11 Extremo Izq
    ]
  },
  '1-4-3-3': {
  ...
  '1-4-2-3-1': {
    my: [
      [50,  90],  // 1 GK
      [18,  74], [38, 74], [62, 74], [82, 74],  // DEF
      [36,  58], [64, 58],                       // doble pivote
      [15,  42], [50, 42], [85, 42],             // mediapuntas
      [50,  26],                                 // delantero
    ],
    rival: [
      [50,  10],  // 1 GK
      [18,  26], [38, 26], [62, 26], [82, 26],  // DEF
      [36,  42], [64, 42],                       // doble pivote
      [15,  58], [50, 58], [85, 58],             // mediapuntas
      [50,  74],                                 // delantero
    ]
  },
  '1-3-5-2': {
    my: [
      [50,  90],  // 1 GK
      [25,  74], [50, 74], [75, 74],             // 3 DEF
      [8,   50], [28, 50], [50, 50], [72, 50], [92, 50],  // 5 MED
      [34,  26], [66, 26],                       // 2 DEL
    ],
    rival: [
      [50,  10],  // 1 GK
      [25,  26], [50, 26], [75, 26],             // 3 DEF
      [8,   50], [28, 50], [50, 50], [72, 50], [92, 50],  // 5 MED
      [34,  74], [66, 74],                       // 2 DEL
    ]
  },
  '1-3-4-3': {
    my: [
      [50,  90],  // 1 GK
      [25,  74], [50, 74], [75, 74],             // 3 DEF
      [15,  50], [38, 50], [62, 50], [85, 50],   // 4 MED
      [15,  26], [50, 26], [85, 26],             // 3 DEL
    ],
    rival: [
      [50,  10],  // 1 GK
      [25,  26], [50, 26], [75, 26],             // 3 DEF
      [15,  50], [38, 50], [62, 50], [85, 50],   // 4 MED
      [15,  74], [50, 74], [85, 74],             // 3 DEL
    ]
  },
  '1-5-3-2': {
    my: [
      [50,  90],  // 1 GK
      [8,   74], [26, 74], [50, 74], [74, 74], [92, 74],  // 5 DEF
      [25,  50], [50, 50], [75, 50],             // 3 MED
      [34,  26], [66, 26],                       // 2 DEL
    ],
    rival: [
      [50,  10],  // 1 GK
      [8,   26], [26, 26], [50, 26], [74, 26], [92, 26],  // 5 DEF
      [25,  50], [50, 50], [75, 50],             // 3 MED
      [34,  74], [66, 74],                       // 2 DEL
    ]
  },
