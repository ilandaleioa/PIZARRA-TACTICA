...
const FORMATIONS = {
  '1-4-4-2': {
    my: [
      ...
      [37,  32],  // 9 Delantero Izq
      [58,  32],  // 10 Delantero Der
      [10,  45],  // 11 Extremo Izq
    ],
    rival: [
      [50,  10],  // 1 GK
      [82,  33],  // 2 Lat Der
      ...
      [37,  68],  // 9 Delantero Izq
      [58,  68],  // 10 Delantero Der
      [10,  55],  // 11 Extremo Izq
    ]
  },
  '1-4-3-3': {
    my: [
      ...
      [83,  32],  // 7 Extremo Der
      [68,  42],  // 8 Interior Der
      [48,  32],  // 9 Delantero Centro
      [27,  42],  // 10 Interior Izq
      [8,   32],  // 11 Extremo Izq
    ],
    rival: [
      [50,  10],  // 1 GK
      ...
      [83,  68],  // 7 Extremo Der
      [68,  58],  // 8 Interior Der
      [48,  68],  // 9 Delantero Centro
      [27,  58],  // 10 Interior Izq
      [8,   68],  // 11 Extremo Izq
    ]
  },
  '1-4-2-3-1': {
